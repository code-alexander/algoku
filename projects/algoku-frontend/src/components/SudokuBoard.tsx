...
const SudokuBoard = ({ givens, entries, selectedIndex, conflicts, onSelect, onMove, onSetCell }: SudokuBoardProps) => {
  ...
  return (
    <div
      ...
      className="grid aspect-square w-full max-w-md grid-cols-9 overflow-hidden rounded-md border bg-background shadow-xs outline-hidden lg:max-w-lg 2xl:max-w-xl"
      role="grid"
